...
void add_ham_term_time_dep(qsystem,PetscScalar,void*,PetscScalar(*)(PetscReal),PetscInt,...);
void add_lin_term_time_dep(qsystem,PetscScalar,void*,PetscScalar(*)(PetscReal),PetscInt,...);
