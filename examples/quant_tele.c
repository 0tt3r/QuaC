...
int main(int argc,char **args){
  ...
  PetscReal gate_time_step,theta,fidelity;
  PetscScalar mat_val;
  PetscInt  steps_max;
  Vec rho;
  ...
  add_gate(5*gate_time_step,HADAMARD,2); //Hadamard on 2
  add_gate(6*gate_time_step,CNOT,0,2); //CNOT(0,2)
  add_gate(7*gate_time_step,HADAMARD,2); //Hadamard on 2
