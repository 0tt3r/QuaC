...
void test_add_ham_lin_1op_basic_real(void)
{
  ...
  strcpy(fname,"1op_br");
  _get_mat_combine_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_ham_lin_1op_pauli_real(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_1op_pauli_complex(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_2op_basic_real(void)
{
...
void test_add_ham_lin_2op_pauli_real(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_2op_basic_complex(void)
{
  PetscScalar omega2,omega3,omega4,omega5;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_2op_pauli_complex(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_3op_basic_real(void)
{
  PetscScalar omega2,omega3,omega4,omega5;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_3op_pauli_real(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_3op_basic_complex(void)
{
  PetscScalar omega2,omega3,omega4,omega5;
  qsystem qsys;
  PetscReal norm;
...
void test_add_ham_lin_3op_pauli_complex(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
...
int main(int argc, char** argv)
{
  ...
  RUN_TEST(test_add_ham_lin_1op_basic_real);
  RUN_TEST(test_add_ham_lin_1op_pauli_real);
  RUN_TEST(test_add_ham_lin_1op_basic_complex);
  RUN_TEST(test_add_ham_lin_1op_pauli_complex);
  RUN_TEST(test_add_ham_lin_2op_basic_real);
  RUN_TEST(test_add_ham_lin_2op_pauli_real);
  RUN_TEST(test_add_ham_lin_2op_basic_complex);
  RUN_TEST(test_add_ham_lin_2op_pauli_complex);
  RUN_TEST(test_add_ham_lin_3op_basic_real);
  RUN_TEST(test_add_ham_lin_3op_pauli_real);
  RUN_TEST(test_add_ham_lin_3op_basic_complex);
  RUN_TEST(test_add_ham_lin_3op_pauli_complex);
