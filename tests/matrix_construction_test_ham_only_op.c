...
void test_add_to_ham_only_1op_basic_real(void)
{
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_1op_br");
...
void test_add_to_ham_only_1op_pauli_real(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_1op_pr");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_1op_basic_complex(void)
{
  PetscScalar omega2,omega3,omega4;
  qsystem qsys;
  char fname[255];
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_1op_bc");
...
void test_add_to_ham_only_1op_pauli_complex(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_1op_pc");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_2op_basic_real(void)
{
  ...
  construct_matrix(qsys);
  strcpy(fname,"tests/pristine_matrices/ham_only_2op_br");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_2op_pauli_real(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_2op_pr");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_2op_basic_complex(void)
{
  PetscScalar omega2,omega3,omega4,omega5;
  qsystem qsys;
  PetscReal norm;
  ...
  construct_matrix(qsys);
  strcpy(fname,"tests/pristine_matrices/ham_only_2op_bc");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_2op_pauli_complex(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_2op_pc");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_3op_basic_real(void)
{
  PetscScalar omega2,omega3,omega4,omega5;
  qsystem qsys;
  PetscReal norm;
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_3op_br");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_3op_pauli_real(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_3op_pr");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_3op_basic_complex(void)
{
  PetscScalar omega2,omega3,omega4,omega5;
  qsystem qsys;
  PetscReal norm;
  ...
  construct_matrix(qsys);
  strcpy(fname,"tests/pristine_matrices/ham_only_3op_bc");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
void test_add_to_ham_only_3op_pauli_complex(void)
{
  PetscScalar omega2;
  qsystem qsys;
  PetscReal norm;
  ...
  strcpy(fname,"tests/pristine_matrices/ham_only_3op_pc");
  _get_mat_and_diff_norm(fname,qsys->mat_A,&norm);
...
int main(int argc, char** argv)
{
  ...
  RUN_TEST(test_add_to_ham_only_1op_basic_real);
  RUN_TEST(test_add_to_ham_only_1op_basic_complex);
  RUN_TEST(test_add_to_ham_only_1op_pauli_real);
  RUN_TEST(test_add_to_ham_only_1op_pauli_complex);
  RUN_TEST(test_add_to_ham_only_2op_pauli_real);
  RUN_TEST(test_add_to_ham_only_2op_pauli_complex);
  RUN_TEST(test_add_to_ham_only_2op_basic_real);
  RUN_TEST(test_add_to_ham_only_2op_basic_complex);
  RUN_TEST(test_add_to_ham_only_3op_basic_real);
  RUN_TEST(test_add_to_ham_only_3op_basic_complex);
  RUN_TEST(test_add_to_ham_only_3op_pauli_real);
  RUN_TEST(test_add_to_ham_only_3op_pauli_complex);
