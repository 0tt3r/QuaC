...
void test_sigmaz(void)
{
  ...
  create_op_sys(qsys,2,&qubit);

  //Build single SIGMAX matrix
  create_circuit(&circ,1);
  add_gate_to_circuit_sys(&circ,1.0,SIGMAZ,0);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ);
...
void test_sigmaz2(void)
{
  ...
  initialize_system(&qsys);
  //Create two level systems
  create_op_sys(qsys,2,&qubit);
  create_op_sys(qsys,2,&qubit2);
  ...
  add_gate_to_circuit_sys(&circ2,1.0,SIGMAZ,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ2);
  ...
  add_gate_to_circuit_sys(&circ3,1.0,SIGMAZ,0);
  add_gate_to_circuit_sys(&circ3,2.0,SIGMAZ,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ3);
...
void test_cnot(void)
{
  ...
  create_circuit(&circ2,1);
  add_gate_to_circuit_sys(&circ2,1.0,CNOT,1,0);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ2);
...
void test_cxz(void)
{
  ...
  //Build single SIGMAX matrix
  create_circuit(&circ,1);
  add_gate_to_circuit_sys(&circ,1.0,CXZ,0,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ);
  ...
  create_circuit(&circ2,1);
  add_gate_to_circuit_sys(&circ2,1.0,CXZ,1,0);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ2);
...
void test_cz(void)
{
  ...
  //Build single SIGMAX matrix
  create_circuit(&circ,1);
  add_gate_to_circuit_sys(&circ,1.0,CZ,0,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ);
  ...
  create_circuit(&circ2,1);
  add_gate_to_circuit_sys(&circ2,1.0,CZ,1,0);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ2);
...
void test_sigmax2(void)
{
  ...
  //Build single SIGMAX matrix
  create_circuit(&circ,1);
  add_gate_to_circuit_sys(&circ,1.0,SIGMAX,0);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ);
  ...
  create_circuit(&circ2,1);
  add_gate_to_circuit_sys(&circ2,1.0,SIGMAX,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ2);
  ...
  create_circuit(&circ3,2);
  add_gate_to_circuit_sys(&circ3,1.0,SIGMAX,0);
  add_gate_to_circuit_sys(&circ3,2.0,SIGMAX,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ3);
...
void test_sigmay2(void)
{
  ...
  //Build single SIGMAX matrix
  create_circuit(&circ,1);
  add_gate_to_circuit_sys(&circ,1.0,SIGMAY,0);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ);
  ...
  create_circuit(&circ2,1);
  add_gate_to_circuit_sys(&circ2,1.0,SIGMAY,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ2);
  ...
  create_circuit(&circ3,2);
  add_gate_to_circuit_sys(&circ3,1.0,SIGMAY,0);
  add_gate_to_circuit_sys(&circ3,2.0,SIGMAY,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ3);
...
void test_hadamard2(void)
{
  ...
  //Build single SIGMAX matrix
  create_circuit(&circ,1);
  add_gate_to_circuit_sys(&circ,1.0,HADAMARD,0);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ);
  ...
  create_circuit(&circ2,1);
  add_gate_to_circuit_sys(&circ2,1.0,HADAMARD,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ2);
  ...
  create_circuit(&circ3,2);
  add_gate_to_circuit_sys(&circ3,1.0,HADAMARD,0);
  add_gate_to_circuit_sys(&circ3,2.0,HADAMARD,1);
  combine_circuit_to_mat_sys(qsys,&circ_mat,circ3);
